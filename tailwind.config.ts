...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'hero': ['clamp(3rem, 8vw, 7.5rem)', { lineHeight: '1', letterSpacing: '-0.01em' }],
        'display': ['clamp(2.5rem, 5vw, 4.5rem)', { lineHeight: '1.1', letterSpacing: '0em' }],
        'title': ['clamp(1.75rem, 3vw, 2.75rem)', { lineHeight: '1.2', letterSpacing: '0.01em' }],
        'subtitle': ['clamp(1.125rem, 1.5vw, 1.375rem)', { lineHeight: '1.4', letterSpacing: '0.015em' }],
